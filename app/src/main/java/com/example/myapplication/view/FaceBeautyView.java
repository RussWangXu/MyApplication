...
public class FaceBeautyView extends BaseCameraView {
    ...
    public void initDetector(Context context) {
        ...
        mFaceDetector = new ObjectDetector(context, R.raw.lbpcascade_frontalface, 6, 0.2F, 0.2F, new Scalar(255, 255, 55, 55));
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        if (faceArray != null && faceArray.length > 0) {
            ...
            //矩形标识
            Imgproc.rectangle(mRgba, rect.tl(), rect.br(), mFaceDetector.getRectColor(), 3,2);
//                if (beauty != null) {
//                    //添加宠萌妆饰
