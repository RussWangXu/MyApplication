...
//        int format = parameters.getPreviewFormat();
        ...
        Log.i("",Arrays.toString(parameters.getSupportedPreviewFormats().toArray()));
        mWidth = optionSize.width;
        mHeight = optionSize.height;
        Log.i("","mWidth"+ optionSize.width + "optionSize.height"+optionSize.height);
        int frame = parameters.getPreviewFrameRate();
        Log.i("",parameters.getPreviewFrameRate() + "哈哈哈");
